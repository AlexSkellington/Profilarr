...
INSERT OR REPLACE INTO custom_formats (name, description, include_in_rename) VALUES ('Size Band: 1080p Compact Eligible', 'Mandatory helper for compact 1080p movie profiles. Matches 1080p releases between about 3.5 GiB and 12 GiB so compact profiles stay in their intended size lane.', 0);
...
INSERT OR REPLACE INTO custom_formats (name, description, include_in_rename) VALUES ('Size Band: 1080p Premium Eligible', 'Mandatory helper for premium 1080p movie profiles. Matches 1080p releases between about 7.5 GiB and 24 GiB so the premium lane can stay closer to remux-sized encodes without turning fully remux-first.', 0);
...
INSERT OR REPLACE INTO custom_formats (name, description, include_in_rename) VALUES ('Size Band: 1080p Remux Eligible', 'Mandatory helper for remux-first 1080p movie profiles. Matches 1080p releases between about 18 GiB and 400 GiB so the remux lane stays open to true remuxes and very large premium encodes without relying on an open-ended size condition.', 0);
...
INSERT OR REPLACE INTO custom_formats (name, description, include_in_rename) VALUES ('Size Band: 4K Compact Eligible', 'Mandatory helper for compact 4K movie profiles. Matches 2160p or 4K releases between about 8 GiB and 22 GiB so compact 4K stays noticeably leaner than the premium and remux lanes.', 0);
...
INSERT OR REPLACE INTO custom_formats (name, description, include_in_rename) VALUES ('Size Band: 4K Premium Eligible', 'Mandatory helper for premium 4K movie profiles. Matches 2160p or 4K releases between about 18 GiB and 50 GiB so the premium lane can ride much closer to remux-sized encodes while still staying below true disk-rip territory most of the time.', 0);
