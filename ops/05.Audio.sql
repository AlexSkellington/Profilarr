...
INSERT OR REPLACE INTO regular_expressions (name, pattern, description) VALUES ('Audio: Lossless Track Bonus', '(?i)\b(?:truehd|true[ ._-]?hd|dts[ ._-]?hd|dts[ ._-]?ma|dts[ ._-]?hd[ ._-]?ma|flac|pcm|lpcm)\b', 'Positive premium-audio detector for TrueHD, DTS-HD MA, FLAC, PCM, and LPCM. Managed profiles use it to reward encoded releases carrying lossless tracks.');
...
INSERT OR REPLACE INTO custom_formats (name, description, include_in_rename) VALUES ('Audio: Lossless Track Bonus', 'Positive premium-audio detector for TrueHD, DTS-HD MA, FLAC, PCM, and LPCM. Managed profiles use it to reward encoded releases carrying lossless tracks.', 0);
